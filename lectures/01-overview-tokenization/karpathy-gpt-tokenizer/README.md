...
Part of the [Neural Networks: Zero to Hero](https://www.youtube.com/watch?v=VMj-3S1tku0&list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ) series. Companion supplement for CS336 Lecture 1 (tokenization).

- **Video**: https://youtu.be/zduSFxRajkE
- **Channel**: Andrej Karpathy
- **Notebook**: [lets_build_the_gpt_tokenizer.ipynb](lets_build_the_gpt_tokenizer.ipynb) — exported from the Colab linked below
- **Colab (original)**: https://colab.research.google.com/drive/1y0KnCFZvGVf_odSfcNAws6kcDD7HsI0L?usp=sharing
- **GitHub repo (minBPE)**: https://github.com/karpathy/minbpe
- **Exercise**: https://github.com/karpathy/minbpe/blob/master/exercise.md
...
- tiktokenizer (web UI): https://tiktokenizer.vercel.app
